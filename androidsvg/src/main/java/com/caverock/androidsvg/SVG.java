...
public class SVG {
    ...
    private SVGDocument rootElement = null;
    ...
    /**
     * Returns a list of all {@code SvgObject} elements found in this SVG document
     *
     * @return the list of {@code SvgObject} elements
     * @throws IllegalArgumentException if there is no current SVG document loaded.
     */
    ...
    void setRootElement(SVGDocument rootElement) {
